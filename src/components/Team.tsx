      ...
      <div className="px-8">
        ...
        <div className="flex flex-col items-center gap-5 ">
          ...
          <div className="flex lg:flex-row flex-wrap justify-center items-center gap-8">
            <Image className="lg:w-[200] lg:h-[200] w-[100] h-[100]" src={tim2} width={200} height={200} alt="tim2" />
            <Image className="lg:w-[200] lg:h-[200] w-[100] h-[100]" src={tim3} width={200} height={200} alt="tim3" />
            <Image className="lg:w-[200] lg:h-[200] w-[100] h-[100]" src={tim4} width={200} height={200} alt="tim4" />
            <Image className="lg:w-[200] lg:h-[200] w-[100] h-[100]" src={tim5} width={200} height={200} alt="tim5" />
          </div>
        </div>
      </div>
    </>
